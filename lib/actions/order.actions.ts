...
// ✅ NEW: Sales data type for chart
type SalesDataType = {
  month: string;
  totalSales: number;
}[];

// ✅ NEW: Get order summary for admin dashboard
export async function getOrderSummary() {
  ...
  // Monthly sales grouped by MM/YY using raw SQL
  ...
  // Latest 6 orders with buyer name
...
// ✅ NEW: Get all orders for admin with pagination
...
// ✅ NEW: Delete an order (admin only)
...
// ✅ NEW: Mark order as paid for Cash on Delivery
